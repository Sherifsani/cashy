...
public class BudgetController {
    ...
    @PostMapping
    public ResponseEntity<BudgetResponseDTO> createBudget(@PathVariable UUID userId,
    ...
    public ResponseEntity<Void> deleteBudget(@PathVariable UUID userId, @PathVariable Long budgetId) {
